...
public interface PersonControllerDocs {
    ...
    @Operation(summary = "Finds a person", description = "Finds a specific person by your ID", tags = {"People"},
            responses = {
    ...
    @Operation(summary = "Export Person data as PDF", description = "Export a specific Person data as PDF by your ID", tags = {"People"},
            responses = {
    ...
    @Operation(summary = "Export People", description = "Export a Page of People in XLSX and CSV format", tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200",
                            content = {
    ...
    @Operation(summary = "Updates a person's data",
            description = "Updates a person's data", tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200", content = @Content(
                            schema = @Schema(implementation = PersonDTO.class)
                    )),
    ...
    @Operation(summary = "Disabling a person", description = "disables a specific person by your ID", tags = {"People"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200", content = @Content(
                            schema = @Schema(implementation = PersonDTO.class)
                    )),

...
public interface EmailControllerDocs {
    ...
    @Operation(summary = "Send an e-mail",
            description = "Sends an e-mail by providing the necessary information in the request body",
            tags = {"E-Mail"},
            responses = {
    ...
    @Operation(summary = "Send an e-mail with attachment",
            description = "Sends an e-mail by providing the necessary information in the request body and an attachment file",
            tags = {"E-Mail"},
            responses = {
                    @ApiResponse(description = "Success", responseCode = "200", content = @Content),
                    @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
